...
gdm_coef_plot <- mbl_gdm_coef %>%
  ...
  geom_hline(aes(xmin = coef - 1.96*stderr, xmax = coef + 1.96*stderr, yintercept = reorder(feature, coef))) + 
  geom_point(aes(x = coef, y = reorder(feature, coef)), color = 'black', shape = 1, show.legend = FALSE) + 
  scale_fill_distiller(palette = 'Spectral') +
  scale_color_distiller(palette = 'Spectral') +
  theme_light() + 
  theme(axis.text.y = element_text(size = 6.5)) +
  labs(y = 'Metabolite', x = 'coefficient', color = 'coefficient') 
