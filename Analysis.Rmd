...
Tweedieverse(input_features = metabolite_infant_df,
             ...
             fixed_effects = c('mother_GDM', 'mother_Age.category', 'mother_BMI.category', 'Gender_of_child'),
             random_effects = c('External_ID'),
             output = 'results_metabolite_mixed_model_1_03May2024',
             plot_scatter = FALSE,
             plot_heatmap = FALSE,
             base_model = "CPLM",
             cores = 4)
...
significant_results_metabolite_mm_df <- read.delim('results_metabolite_mixed_model_1_03May2024/significant_results.tsv') 
...
significant_results_metabolite_mm_df2$metadata <-
  factor(significant_results_metabolite_mm_df2$metadata,
         levels = c("Gender_of_child", "mother_Age.category", "mother_BMI.category", "mother_GDM"),
         labels = c("Gender", "Age", "BMI", "GDM"))
         

write.csv(x = significant_results_metabolite_mm_df2,
          file = 'significant_results_metabolite_full_model_03May2024.csv',
          row.names = FALSE)
